...
def filter_google_search_results(company_description, search_results):
    ...
    completion = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Do not explain your answer. Output list of news with the date each item happened, the link to source article URL, and complete summary of the news, with the irrelevant ones removed. Output 'None.' if no relevant news was provided. "},
